...
export function ChatGPTPlayground({
  ...
  const { generate, isLoading, error } = useChatGPT({ apiUrl });
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-transparent"
              >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center text-gray-500 dark:text-gray-400 py-8">
            ...
            <p className="text-sm mt-1">{GPT_MODELS.find((m) => m.id === selectedModel)?.name || selectedModel}</p>
          </div>
        )}
