...
### Шаг 1: Получить API ключ и сохранить

**Сразу попроси у пользователя:**

> Для подключения ChatGPT мне нужен API ключ от Polza.ai.
>
> **Если есть** — пришлите его. **Если нет** — зарегистрируйтесь на [polza.ai](https://polza.ai), создайте ключ в [Ключи API](https://polza.ai/dashboard/api-keys) и пополните баланс (от 100₽).

**Когда получил ключ — СРАЗУ вызови:**
